...
> * 상세설계(02-detail-design.md)의 테스트 시나리오와 매핑합니다.

---

## 0. 문서 메타데이터

* **문서명**: `03-implementation.md`
* **Task ID**: TSK-XX-XX-XX
* **Task 명**: [Task 전체 명칭]
* **작성일**: YYYY-MM-DD
* **작성자**: [작성자명 또는 AI Agent]
* **참조 상세설계서**: `./02-detail-design.md`
...
├── 02-detail-design.md     ← 상세설계
├── 03-implementation.md    ← 구현 보고서 (본 문서)
└── test-results/           ← 테스트 결과
    ├── tdd/
    └── e2e/
```

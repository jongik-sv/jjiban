...
**development, defect, infrastructure 카테고리는 기존 `/wf:start` 사용**
...
| 카테고리 확인 | `simple-dev` 여야 함 | 아니면 `/wf:start` 안내 |
...
| 잘못된 카테고리 | `[ERROR] simple-dev 카테고리가 아닙니다. /wf:start 사용` |

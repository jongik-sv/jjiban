...
| TC-004-003 | 모든 Task 미완료 | WP → 5개 TSK (모두 [ ]) | 0% | 필수 |
...
| 검증 항목 | 계산 방법 | 예시 |
|----------|----------|------|
| 완료율 | (완료 Task / 전체 Task) × 100 | 2/4 = 50% |
| 재귀 계산 | 하위 모든 Task 수집 | WP → ACT → TSK 모두 포함 |
...
|-------|---------|----------|----------|---------|
| TC-005-001 | 실제 wbs.md 파싱 | `fixtures/wbs/jjiban-wbs.md` | 56개 노드, 계층 구조 정확 | 필수 |
...
| 파일명 | 내용 | 용도 |
|--------|------|------|
| `jjiban-wbs.md` | 실제 프로젝트 wbs.md | 실전 테스트 |

...
**재현 단계:**
1. WBS 페이지 접속 (`/wbs?project=jjiban-test-detail-panel`)
...
- 프로젝트 ID: `jjiban-test-detail-panel`
...
```bash
# 결함 수정 완료 후
jjiban workflow TSK-05-01 verify
```
...
- 코드 리뷰: `.jjiban/projects/jjiban/tasks/TSK-05-01/031-code-review-claude-1(적용완료).md`
- 구현 문서: `.jjiban/projects/jjiban/tasks/TSK-05-01/030-implementation.md`
